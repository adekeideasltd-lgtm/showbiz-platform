...
const User = sequelize.define('User', {
  ...
  deletion_requested_at:   { type: DataTypes.DATE },
  deletion_scheduled_at:   { type: DataTypes.DATE },
...
const Booking = sequelize.define('Booking', {
  ...
  refund_tier:               { type: DataTypes.STRING(20) },
  cancellation_requested_at: { type: DataTypes.DATE },
  cancellation_status:       { type: DataTypes.STRING(20) },
